...
% ATENÇÃOoooooooooooOoOooOooOooOoOOoooo, READ-ME, LEIA AQUI
...
\title[Arquitetura de Computadores - UFOP]{\textbf{\titulo}\\}
...
\include{./tex/tr}
\include{./tex/met1}
%\include{./tex/mesdft2} % do not utilize
\include{./tex/implementacao}
%\include{./tex/conc}
